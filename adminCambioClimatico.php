...
$query = "SELECT * FROM cambio_climatico";
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        ...
                        <div class="modal-dialog">
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="post" action="assets/crud_contenido/crear_energiaR.php">
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            <form method = "POST" action="assets/crud_contenido/eliminarCambioClimatico.php">
