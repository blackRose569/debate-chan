...
$query = "SELECT * FROM `cambio_climatico` ORDER BY fecha DESC;";
...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('assets/img/cambioclimatico_1.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>Cambio climático</h1>
                            <span class="subheading">En este espacio se debatirán ambas posturas sobre este tema</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="post-preview">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Nuevo hilo: Cambio climático</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="post" action="assets/crud_contenido/crear_cambioC.php">
                                ...
                                <div class="group"> <input type="submit" id="boton" class="btn btn-success" value="Guardar publicacion"> </div>
                                <script>
                                    ...
                                    var improperios = ["ctm","puta", "csm", "maricon","qlo","mierda","perra","bastardo","bastarda"]
                     ...
                     <div>
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        <td class="card-body" ><?php echo $contenido['titulo_tema'] ?></td>
