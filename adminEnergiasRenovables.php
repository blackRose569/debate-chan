...
$query = "SELECT * FROM energia_renovable";
                    ...
                    <div class="post-preview">
                        ...
                        <div class="modal-dialog">
                            ...
                            <form id="formulario" data-sb-form-api-token="API_TOKEN" method="post" action="assets/crud_contenido/crear_energiaR.php">
                                ...
                                <div class="group"> <input type="submit" name="boton" id="boton" class="btn btn-success" value="Guardar propuesta"> </div>
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            <form method = "POST" action="assets/crud_contenido/eliminarEnergiasRenovables.php">
